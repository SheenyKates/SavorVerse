...
<head>
    ...
    <title>SavorVerse - Category</title>
    {{-- Vite CSS & JS --}}
...
<header class="header">
    ...
    <nav class="nav-links">
        ...
        <a href="{{ url('/category') }}" class="nav-item active">CATEGORY</a>
...
<main class="main-content">
    <section class="category-wrapper">
        ...
        <div class="category-buttons">
            ...
            <button class="category-btn active" data-category="Beef">BEEF</button>
        ...
        <div class="dish-results" id="dish-results">
            <!-- Dynamic dish cards will go here -->
        </div>
    </section>
</main>
